...
namespace SonarLint.Runner
{
    public class DiagnosticsRunner
    {
        ...
        public IEnumerable<Diagnostic> GetDiagnostics(Compilation compilation,SyntaxTree syntaxTree)
        {
            ...
            var modifiedCompilation = compilation.WithOptions(compilationOptions).RemoveAllSyntaxTrees();
            modifiedCompilation=modifiedCompilation.AddSyntaxTrees(syntaxTree);
