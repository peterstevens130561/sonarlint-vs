...
namespace SonarLint.Rules
{
    ...
    [SqaleSubCharacteristic(SqaleSubCharacteristic.Errors)]
    [Rule(DiagnosticId, RuleSeverity, Title, IsActivatedByDefault)]
    [Tags("misra", "unused")]
    public class ToDo : DiagnosticAnalyzer
    {
        internal const string DiagnosticId = "BHI1000";
        internal const string Title = "// TODO:: should be done at a certain moment";
        internal const string Description =
            "TODO comments should be done before a user story is done " ;
        internal const string MessageFormat = "Shouldn't you have done TODO?";
                        ...
                        Action<IEnumerable<SyntaxTrivia>> check =
                            trivias =>
                            {
                                ...
                                foreach (var trivia in trivias)
                                {
                                    ...
                                    {
                                        var line = triviaLines[triviaLineNumber];
